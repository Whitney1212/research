...
- 固定塔 rotation 与 W3 年度重算默认使用 `*_standardized_30min.csv`；公共矩阵固定为 `no_rotation / dr / global_pf / sector_pf`，`MT season_sector_pf` 仅作 MT-only 敏感性。 [已核验: anchors/03_active_decisions.md]
