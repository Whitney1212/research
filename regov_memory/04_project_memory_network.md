...
- 最近关键证据：`2026-06-12_fl_pf8bin_record_position_actual_speed.md` 记录了 FL `PF_8bin` 正式参数口径，包含运行记录逐点位置、实际速度矢量修正、8-bin PF 拟合结果和后续高频通量调用约束。 [已核验: D:\00 博士阶段\99 Project\06 EA\project_memory\evidence\verifications\2026-06-12_fl_pf8bin_record_position_actual_speed.md]
