...
- W2 2025 晨间 peak 当前固定塔 AP 主输入为 AP200 QC 后 cycle 文件：`E:\Dataset_Level1\MT\AP\20240704-20260622\MT_AP_profile_cycle_after_qc_20240704_20260622.csv` 与 `E:\Dataset_Level1\CVT\AP\20240704-20260622\CVT_AP_profile_cycle_after_qc_20241112_20260622.csv`。由此生成的基础表、事件表和幅度图分别在 `E:\Dataset_Level1\MorningPeak\W2_2025_foundation` 与 `E:\Dataset_Level1\MorningPeak\W2_2025_candidates\auto_peak_r_2025`。 [来源: 用户当前对话 2026-07-01] [已核验: D:\00 博士阶段\99 Project\06 EA\project_memory\evidence\verifications\2026-07-01_w2_morning_peak_rerun_after_ap200_qc.md]
...
- AP200 QC 后 W2 2025 当前分母与候选数为：`CVT usable=336, amp>0=204, >=5 ppm=86, >=10 ppm=42`；`MT usable=338, amp>0=213, >=5 ppm=91, >=10 ppm=47`。这些数量替代 6 月 29/30 日旧 Level0 初筛候选数，作为后续事件表和图件的当前引用基线。 [来源: 用户当前对话 2026-07-01] [已核验: D:\00 博士阶段\99 Project\06 EA\project_memory\evidence\verifications\2026-07-01_w2_morning_peak_rerun_after_ap200_qc.md]
