...
- REgov dashboard 脚本可以读取当前项目和 `04 Lee`，并生成测试图谱 `D:\00 博士阶段\99 Project\06 EA\regov_dashboard\workstream_map_test.md`。 [已核验: D:\00 博士阶段\99 Project\06 EA\regov_dashboard\workstream_map_test.md]
- 测试 dashboard 已识别当前项目 `W1`，以及 `04 Lee` 的 `W1`、`W2`、`W3`、`W4` 四条工作流。 [已核验: D:\00 博士阶段\99 Project\06 EA\regov_dashboard\workstream_map_test.md]
